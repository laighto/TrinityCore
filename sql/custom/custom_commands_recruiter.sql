...
('recruit friend', 1000, 'Syntax: .recruit friend $CharacterName\r\nAllow set ingame friend(recruiter) to get party bonuses'),
('recruit delete', 1000, 'Syntax: .recruit delete\r\nAllow delete recruiter data');

DELETE FROM `trinity_string` WHERE entry IN (788, 789, 790, 791, 792);
...
INSERT INTO `rbac_permissions` (`id`, `name`) VALUES ('1000', 'recruit');
DELETE FROM `rbac_permissions` WHERE permissionId=1000 ;
INSERT INTO `rbac_role_permissions` (`roleId`, `permissionId`) VALUES ('1', '1000');