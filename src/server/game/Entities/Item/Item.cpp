...
FakeResult Item::SetFakeDisplay(uint32 iEntry)
{
    ...
    /*if (myTmpl->AllowableClass != otherTmpl->AllowableClass)
        if(((otherTmpl->AllowableClass != -1) && (otherTmpl->AllowableClass != 2047) && (otherTmpl->AllowableClass != 32767) && (otherTmpl->AllowableClass != 262143))
        || ((myTmpl->AllowableClass != -1) && (myTmpl->AllowableClass != 2047) && (myTmpl->AllowableClass != 32767) && (myTmpl->AllowableClass != 262143)))
