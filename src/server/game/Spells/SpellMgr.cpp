    ...
    for (uint32 i = 0; i < GetSpellInfoStoreSize(); ++i)
    {
        ...
        switch (spellInfo->Id)
        {
            ...
            case 54109: // WintergraspSiegeEngine Ram
                ...
                spellInfo->Effects[EFFECT_0].RadiusEntry = sSpellRadiusStore.LookupEntry(EFFECT_RADIUS_8_YARDS); // SPELL_EFFECT_KNOCK_BACK
                spellInfo->Effects[EFFECT_1].RadiusEntry = sSpellRadiusStore.LookupEntry(EFFECT_RADIUS_8_YARDS); // SPELL_EFFECT_SCHOOL_DAMAGE
                spellInfo->Effects[EFFECT_2].RadiusEntry = sSpellRadiusStore.LookupEntry(EFFECT_RADIUS_13_YARDS); // SPELL_EFFECT_WMO_DAMAGE, Huck but it must be -> Fortress towers are much bigger than original WMO damage radius of spell
                break;
            case 62345: // UlduarSiegeEngine Ram set radius of WMO damage
                spellInfo->Effects[EFFECT_2].RadiusEntry = sSpellRadiusStore.LookupEntry(EFFECT_RADIUS_13_YARDS); // SPELL_EFFECT_WMO_DAMAGE, Huck but it must be -> Fortress towers are much bigger than original WMO damage radius of spell
                break;
            ...
            case 62968: // Brightleaf's Essence
                ...
                break;
            case 38790:
                spellInfo->Effects[EFFECT_1].Effect = SPELL_EFFECT_KILL_CREDIT;
                spellInfo->Effects[EFFECT_1].MiscValue = 22112;
                break;
            case 18754: // Improved succubus - problems with apply if target is pet
                ...
                spellInfo->Effects[EFFECT_0].BasePoints = int32(-1.5*IN_MILLISECONDS*0.22);           // reduce cast time of seduction by 22% 
                spellInfo->Effects[EFFECT_0].TargetA = SpellImplicitTargetInfo(TARGET_UNIT_CASTER);
                break;
            case 18755:
                spellInfo->Effects[EFFECT_0].ApplyAuraName = SPELL_AURA_ADD_FLAT_MODIFIER;
                spellInfo->Effects[EFFECT_0].BasePoints = int32(-1.5*IN_MILLISECONDS*0.44);           //  reduce cast time of seduction by 44%
                spellInfo->Effects[EFFECT_0].TargetA = SpellImplicitTargetInfo(TARGET_UNIT_CASTER);
                break;
            case 18756:
                spellInfo->Effects[EFFECT_0].ApplyAuraName = SPELL_AURA_ADD_FLAT_MODIFIER;
                spellInfo->Effects[EFFECT_0].BasePoints = int32(-1.5*IN_MILLISECONDS*0.66);           //  reduce cast time of seduction by 66%
                spellInfo->Effects[EFFECT_0].TargetA = SpellImplicitTargetInfo(TARGET_UNIT_CASTER);
                break;
            case 52916:
                spellInfo->AttributesEx3 |= SPELL_ATTR3_NO_INITIAL_AGGRO;
            ...
            case 67202: // Item - Priest T9 Healing 4P Bonus
                spellInfo->Effects[EFFECT_0].ApplyAuraName = SPELL_AURA_ADD_PCT_MODIFIER;
                spellInfo->Effects[EFFECT_0].MiscValue = 0;
                spellInfo->Effects[EFFECT_0].SpellClassMask = flag96(0x00000000, 0x01000000, 0x00001000);
                break;
            ...
            case 60895: // Crushing Leap (heroic)
                ...
                spellInfo->RangeEntry = sSpellRangeStore.LookupEntry(134);
                break;
            case 71267: //Swarming Shadows Periodic Damage Aura Huck
                spellInfo->DurationEntry = sSpellDurationStore.LookupEntry(9); // Add 15 seconds cd instead inf
                break;
            ...
            case 74174: // Shoot
            case 74182: // Shoot
                spellInfo->Effects[EFFECT_0].RadiusEntry = sSpellRadiusStore.LookupEntry(40);
                break;
