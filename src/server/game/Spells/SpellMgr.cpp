    ...
    for (uint32 i = 0; i < sSpellStore.GetNumRows(); ++i)
    {
        ...
        switch (spellInfo->Id)
        {
            ...
            case 54109: // WintergraspSiegeEngine Ram
                ...
                spellInfo->EffectRadiusIndex[2] = EFFECT_RADIUS_13_YARDS; // SPELL_EFFECT_WMO_DAMAGE, Huck but it must be -> Fortress towers are much bigger than original WMO damage radius of spell
                break;
