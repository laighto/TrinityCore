...
void World::LoadConfigSettings(bool reload)
{
    ...
    m_bool_configs[CONFIG_ALLOW_LICH_KING_ENTRANCE]                  = sConfigMgr->GetBoolDefault("AllowEnterRaidFrozenThrone", false);
    ...
    // chatlog
    m_bool_configs[CONFIG_ChatLog_Lexics_Action_Custom] = sConfigMgr->GetBoolDefault("ChatLog.Lexics.Action.Custom", false);
    m_int_configs[CONFIG_ChatLog_Lexics_Action_Custom_MODE] = sConfigMgr->GetIntDefault("ChatLog.Lexics.Action.Custom.Mode", 0);
    m_int_configs[CONFIG_ChatLog_Lexics_Action_Custom_Spell] = sConfigMgr->GetIntDefault("ChatLog.Lexics.Action.Custom.Punish.Spell", 0);

    //Transmogrification
    m_int_configs[CONFIG_TRANSMOGRIFY_PRICE] = sConfigMgr->GetIntDefault("TransmogrifyPrice", 1);
...
void World::ResetDailyQuests()
{
    ...
    // Reset pool_quest_save - fix duplicates at NPC gossip
